...
function Hero(){
    return(
        <div id='hero' className='container mx-auto h-screen hero-container flex flex-col justify-center mt-10'>
            ...
            <Fade duration={2000} delay={500}>
                <div style={styles.header} className='flex flex-col text-center font-bold sm:text-3xl  md:text-5xl lg:text-6xl'>
