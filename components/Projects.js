...
function Projects(){
    ...
    return(
        <div id='projects' className='container mx-auto projects mt-6'>
                ...
                {data.projects.map((project,i)=>{
                    return (
                        <div className='flex flex-col items-center' key={i}>
                            ...
                            <h3 className='font-bold mt-2 -mb-16 md:mb-1 '>{project.setup} Project | {project.timeframe}</h3>
                            ...
                            <p className='-mt-16 w-4/5 -mt-12 mb-4'>{project.description}</p>
